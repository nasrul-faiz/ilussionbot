...
exports.getTime = (format, date) => {
    if (date) {
        ...
        return moment.tz(settings.timeZone || 'Asia/Kuala_Lumpur').locale('id').format(format)
    }
}
...
exports.tanggal = (numer) => {
    ...
    const time = moment.tz(settings.timeZone || 'Asia/Kuala_Lumpur').format('DD/MM HH:mm:ss');
    const d = new Date();
    const locale = 'id';
